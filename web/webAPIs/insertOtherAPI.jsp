...
<%@page language="java" import="model.newTable.StringData" %>
<%@page language="java" import="model.newTable.StringDataList" %>
<%@page language="java" import="model.newTable.DbMods" %>
...
<%
    ...
    if (jsonInsertData == null) {
        ...
        if (errorMsgs.errorMsg.length() == 0) { // means db connection is ok
            ...
            errorMsgs = model.newTable.DbMods.insert(insertData, dbc); // this is the form level message
        }
    }
