function deleteGraphics() {
    ...
    var content = ` 
      <div>
            <h3>Delete Tester</h3>
            Enter id of a card: <input type="text" id="inputId"/>
            <button onclick="callGraphicsDeleteAPI()">Delete</button>
            <p></p>
            <div id="message"></div>
        </div>
...
function callGraphicsDeleteAPI() {
                    ...
                    ajax("webAPIs/deleteOtherAPI.jsp?deleteId=" + idToDelete, APISuccess, messageDOM);
